  ...
  return (
    <View>
      ...
      <View className={cn('flex flex-col gap-1.5')}>
        {label && (
          <Text className={cn(`text-base text-primary ${errorMessages && 'text-red-600'}`, labelClasses)}>
            {label}
          </Text>
        )}
        <TouchableOpacity
          ...
          className={cn(
            selectClasses,
            `border border-input py-2.5 px-4 rounded-lg bg-white dark:bg-black ${errorMessages && 'border-red-600'}`
          )}
